...
public class DBServiceMyORMImpl implements DBService {
    ...
    private CacheService cacheProxy;

    public DBServiceMyORMImpl(MyORMConfig config) {
        executor = new MyORMExecutor(config);
        ...
        cacheProxy = new CacheProxy(executor.getCache());
    }
